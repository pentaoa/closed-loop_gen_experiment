...
def get_selected_channel_idxes(data, fs=250, n_selected_channels=6):
    """
...
def train_emotion_classifier(features, labels, test_size=0.2, random_state=42):
    ...
    :param features: 特征数据，形状为 (n_samples, n_features)
    :param labels: 标签数据，形状为 (n_samples,)
    :param test_size: 测试集比例，默认 0.2
    :param random_state: 随机种子，默认 42
    :return: 训练好的模型和分类报告
    """
