...
class Generator4Embeds:
    ...
    def __init__(self, guidance_scale=0.0, num_inference_steps=4,device='cuda') -> None:
        # import os
    ...
    def generate(self, image_embeds, guidance_scale=0.0, text_prompt='', generator=None):
...
if __name__ == "__main__":
    ...
    from IPython.display import Image, display
    generator = Generator4Embeds(num_inference_steps=4, guidance_scale=2.0)
...
# generator = Generator4Embeds(guidance_scale=2.0, num_inference_steps=4)
# model_weights_path = '/mnt/dataset0/jiahua/open_clip_pytorch_model.bin'
# image = generator.generate(image_embeds=torch.randn(1,1024), guidance_scale=2.0, text_prompt='a dog on the grass.')
# image_path = "/mnt/dataset0/jiahua/closed-loop/generated_image.png"  
