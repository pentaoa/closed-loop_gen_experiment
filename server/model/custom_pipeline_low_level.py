...
class Generator4Embeds:
    ...
    def __init__(self, num_inference_steps=1, device='cuda', img2img_strength=1, low_level_image=None, low_level_latent = None) -> None:
        ...
        from model.extended_diffusers import ExtendedStableDiffusionXLPipeline
        from safetensors.torch import load_file
        from diffusers import AutoencoderKL, DDIMScheduler, UNet2DConditionModel
        from huggingface_hub import hf_hub_download
        # model_id = "stabilityai/sdxl-turbo"
        model_id = "stabilityai/stable-diffusion-xl-base-1.0"
        unet = UNet2DConditionModel.from_pretrained(model_id, subfolder="unet", torch_dtype=torch.bfloat16, use_safetensors=True, variant="fp16")
        ...
        pipe = ExtendedStableDiffusionXLPipeline.from_pretrained(model_id, unet=unet, vae=vae, scheduler=scheduler, torch_dtype=torch.bfloat16, use_safetensors=True, variant="fp16")
